...
local function ExtractUnitFromModifiers(modifiers)
...
function DataTokens:ProcessTemplate(template, context)
	...
	while pos <= #template do
		...
		local unitFromModifier = ExtractUnitFromModifiers(modifiers);
...
-- Export ExtractUnitFromModifiers as a module function for external use
